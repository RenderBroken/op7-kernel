...
MODULES_DIR="${HOME}/android/source/kernel/AnyKernel3/ramdisk/overlay/modules"
...
function make_clang_kernel {
	...
	REAL_CC="${HOME}/android/source/toolchains/clang-linux-x86/clang-r353983c/bin/clang"
