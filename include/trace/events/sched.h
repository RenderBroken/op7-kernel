...
TRACE_EVENT(sched_task_util,
	...
	TP_ARGS(p, next_cpu, backup_cpu, target_cpu, sync, need_idle, fastpath,
		placement_boost, rtg_cpu, ux_task, start_t, stune_boosted, sync_boost),
	...
	TP_printk("pid=%d comm=%s util=%lu prev_cpu=%d next_cpu=%d backup_cpu=%d target_cpu=%d sync=%d need_idle=%d fastpath=%d placement_boost=%d rtg_cpu=%d latency=%llu uxtop=%d stune_boosted=%d sync_boost=%d",
		...
		__entry->ux_task, __entry->stune_boosted, __entry->sync_boost)
)
